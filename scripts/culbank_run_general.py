...
from config.prompt.templates import (
    ...
    general_inference as general_inference,
...
# api_model = "o1-mini"
api_model = "o1"
print(f'Running {api_model} General Infer for {run_type} from {start} to {end} for {len(input_data)} samples')
# api_model = "gpt-4o"
# api_model = "o1"
# api_model = "o1-mini"
...
for l in range(level):
    ...
    os.makedirs(f'{data_dir}/general_generated_results/{api_model}/{run_type}/culbank_infer_data_{l}', exist_ok=True)
...
for i in tqdm.tqdm(range(start, end)):
    for l in range(level):
        ...
        save_path = f'{data_dir}/general_generated_results/{api_model}/{run_type}/culbank_infer_data_{l}/{run_type}_{i}.json'
        # if file exists, skip
