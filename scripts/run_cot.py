...
from config.prompt.templates import (
    ...
    # general_inference as en_general_inference,
    cot_inference_o1 as en_cot_inference_o1,
    cot_inference_4o as en_cot_inference_4o,
...
from config.prompt.templates_de import (
    ...
    # general_inference as de_general_inference,
    cot_inference_o1 as de_cot_inference_o1,
    cot_inference_4o as de_cot_inference_4o,
...
from config.prompt.templates_fr import (
    ...
    # general_inference as fr_general_inference,
    cot_inference_o1 as fr_cot_inference_o1,
    cot_inference_4o as fr_cot_inference_4o,
...
from config.prompt.templates_zh import (
    ...
    # general_inference as zh_general_inference,
    cot_inference_o1 as zh_cot_inference_o1,
    cot_inference_4o as zh_cot_inference_4o,
...
from config.prompt.templates_ja import (
    ...
    # general_inference as ja_general_inference,
    cot_inference_o1 as ja_cot_inference_o1,
    cot_inference_4o as ja_cot_inference_4o,
...
all_prompts['en'] = {
    ...
    # 'general_inference': en_general_inference,
    'cot_inference_o1': en_cot_inference_o1,
    'cot_inference_4o': en_cot_inference_4o,
}
...
all_prompts['ja'] = {
    ...
    # 'general_inference': ja_general_inference,
    'cot_inference_o1': ja_cot_inference_o1,
    'cot_inference_4o': ja_cot_inference_4o,
}
...
all_prompts['zh'] = {
    ...
    # 'general_inference': zh_general_inference,
    'cot_inference_o1': zh_cot_inference_o1,
    'cot_inference_4o': zh_cot_inference_4o,
}
...
all_prompts['de'] = {
    ...
    # 'general_inference': de_general_inference,
    'cot_inference_o1': de_cot_inference_o1,
    'cot_inference_4o': de_cot_inference_4o,
}
...
all_prompts['fr'] = {
    ...
    # 'general_inference': fr_general_inference,
    'cot_inference_o1': fr_cot_inference_o1,
    'cot_inference_4o': fr_cot_inference_4o,
}
...
def run_infer(inp, api_model="gpt-4o", seed=1000):
    ...
    # sys_prompt = all_prompts[run_lang]['general_inference']
    if 'o1' in api_model:
        sys_prompt = all_prompts[run_lang]['cot_inference_o1']
    else:
        sys_prompt = all_prompts[run_lang]['cot_inference_4o']
...
# api_model = "o1-mini"
api_model = "o1"
print(f'Running {api_model} CoT Infer for {run_lang} from {start} to {end} for {len(input_data)} samples')
# api_model = "gpt-4o"
# api_model = "o1"
# api_model = "o1-mini"
# api_model = "o1-preview"
...
for l in range(level):
    ...
    os.makedirs(f'{data_dir}/cot_generated_results/{api_model}/{run_lang}/mcsqa_infer_data_{l}', exist_ok=True)
...
for i in tqdm.tqdm(range(start, end)):
    for l in range(level):
        ...
        save_path = f'{data_dir}/cot_generated_results/{api_model}/{run_lang}/mcsqa_infer_data_{l}/{run_lang}_{i}.json'
        # if file exists, skip
