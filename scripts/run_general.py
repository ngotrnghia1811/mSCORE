...
api_model = "o1-mini"
# api_model = "o1"
print(f'Running {api_model} General Infer for {run_lang} from {start} to {end} for {len(input_data)} samples')
# api_model = "gpt-4o"
# api_model = "o1"
# api_model = "o1-mini"
# api_model = "o1-preview"
...
for l in range(level):
    ...
    os.makedirs(f'{data_dir}/general_generated_results/{api_model}/{run_lang}/mcsqa_infer_data_{l}', exist_ok=True)
...
for i in tqdm.tqdm(range(start, end)):
    for l in range(level):
        ...
        save_path = f'{data_dir}/general_generated_results/{api_model}/{run_lang}/mcsqa_infer_data_{l}/{run_lang}_{i}.json'
        # if file exists, skip
