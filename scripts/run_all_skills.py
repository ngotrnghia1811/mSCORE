...
def run_infer(inp, api_model="gpt-4o", seed=1000):
    ...
    if api_model == 'o1-mini' or api_model == 'o1-preview':
        messages = [
            {"role": "user", "content": all_prompts[run_lang]['standard_inference']},
            {"role": "user", "content": input_prompt}
        ]
        ...
        messages = [
            {"role": "developer", "content": all_prompts[run_lang]['standard_inference']},
            {"role": "user", "content": input_prompt}
        ]
        ...
        messages = [
            {"role": "system", "content": all_prompts[run_lang]['standard_inference']},
            {"role": "user", "content": input_prompt}
        ]
...
# api_model = "gpt-4o"
api_model = "o1-mini"
print(f'Running {api_model} Infer for {run_lang} from {start} to {end} for {len(input_data)} samples')
# api_model = "o1-mini"
# api_model = "o1-preview"
level = 4
